...
[arabic]
. Go to https://www.zotero.org/settings/keys[zotero.org/settings/keys]
. Note your *User ID* (numeric, shown at top)
. Create a new *API Key* with read access

==== 2. Test the API (No WordPress Needed)

Open `+standalone.html+` in your browser and enter your credentials to
test.
