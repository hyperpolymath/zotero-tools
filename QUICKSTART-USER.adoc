...
// Replace zotero-tools, Zotero Tools — See README.adoc for details., just run, Zotero Tools started successfully. with actuals
= zotero-tools — Quick Start for Users
:toc:
:toclevels: 2

== What is zotero-tools?

Zotero Tools — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./zotero-tools-portable
----
...
[source]
----
Zotero Tools started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/zotero-tools/wiki
