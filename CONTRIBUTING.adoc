...
git clone https://github.com/hyperpolymath/language-bridges.git cd
language-bridges
...
toolbox create language-bridges-dev toolbox enter language-bridges-dev #
...
language-bridges/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
