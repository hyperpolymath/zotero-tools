...
git clone https://github.com/hyperpolymath/zotero-tools.git cd
zotero-tools
...
toolbox create zotero-tools-dev toolbox enter zotero-tools-dev # Install
...
zotero-tools/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
