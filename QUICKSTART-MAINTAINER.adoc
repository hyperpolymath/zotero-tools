...
// Replace zotero-tools, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= zotero-tools — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining zotero-tools for
...
* Upstream: https://github.com/hyperpolymath/zotero-tools/issues
