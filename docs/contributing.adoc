...
= Contributing — zotero-tools
:revdate: 2026-MM-DD

== Audience

Developers working *on* `zotero-tools`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/zotero-tools.git
cd zotero-tools
...
* Bugs in `zotero-tools`: file at `hyperpolymath/zotero-tools/issues`.
