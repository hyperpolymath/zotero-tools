...
- ✅ **No credentials in URLs** (no tokens, passwords)
- ✅ **Public key authentication** (phishing-resistant)
- ✅ **Agent forwarding** (convenient, secure)
- ✅ **Per-repository keys** (granular access control)
- ✅ **Host key verification** (MITM protection)

**HTTPS disadvantages:**
- ❌ **Tokens in URLs** (can leak in logs)
- ❌ **Credential caching** (security risk)
- ❌ **Password auth** (phishing vulnerability)
- ❌ **No forward secrecy** (TLS 1.2)
...
- ✅ Strong MAC algorithms (HMAC-SHA2-512-ETM)
- ✅ Host key verification (TOFU)
- ✅ Ed25519 signatures (or Ed448)
