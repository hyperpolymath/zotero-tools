...
- ✅ Simplified configuration (no negotiation pitfalls)

**Disable:**
- ❌ TLS 1.2 and earlier (if possible)
- ❌ SSL 3.0, SSL 2.0 (ancient, broken)
...
- ✅ ECDSA or RSA - authentication
- ✅ AES-GCM or ChaCha20-Poly1305 - authenticated encryption
- ✅ SHA-256 or SHA-384 - strong hash
...
**Why OCSP Stapling:**
- ✅ Privacy (client doesn't contact CA)
- ✅ Performance (server caches OCSP response)
- ✅ Reliability (no OCSP server downtime)
