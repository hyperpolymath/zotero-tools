...
[arabic]
. Navigate to
https://github.com/hyperpolymath/language-bridges/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |https://hyperpolymath.github.io/pgp.asc[Download Public Key]
|*Fingerprint* |`+TBD+`
|===
...
https://github.com/hyperpolymath/language-bridges/security/advisories[Security
Advisories]
...
* https://hyperpolymath.github.io/pgp.asc[Our PGP Public Key]
* https://github.com/hyperpolymath/language-bridges/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/language-bridges/discussions[GitHub
Discussions]
...
_Thank you for helping keep language-bridges and its users safe._ 🛡️
