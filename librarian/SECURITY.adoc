...
[arabic]
. Navigate to
https://github.com/hyperpolymath/zotero-tools/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/zotero-tools/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/zotero-tools/discussions[GitHub
Discussions]
...
_Thank you for helping keep Zotero Tools and its users safe._ 🛡️
